document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        id: {
            ...
            hero_desc: "Sarjana Teknik Informatika dengan total pengalaman kerja profesional 4+ tahun, meliputi 2+ tahun fokus di bidang IT, Pengembangan ERP & Infrastruktur, serta 2 tahun di bidang Pengadaan (Procurement) & Administrasi Proyek EPC. Memiliki kombinasi keahlian teknis rekayasa sistem dan pemahaman operasional bisnis yang kuat.",
            ...
            about_p1: "Sarjana Teknik Informatika dengan total pengalaman kerja profesional 4+ tahun, meliputi 2+ tahun fokus di bidang IT, Pengembangan ERP & Infrastruktur, serta 2 tahun di bidang Pengadaan (Procurement) dan Administrasi Proyek EPC.",
            about_p2: "Menggabungkan keahlian rekayasa perangkat lunak & infrastruktur IT dengan pemahaman riil operasional lapangan (pengadaan, logistik, dan kontrol dokumen) untuk membangun solusi digital yang presisi.",
            ...
            it_item1_title: "Infrastruktur Server & Cloud Storage",
            it_item1_desc: "Pengelolaan Proxmox, Docker, Nginx, CI/CD pipeline, Nextcloud & NAS cloud storage, Grafana, dan Kuma Uptime.",
            it_item2_title: "Pengembangan ERP & Web Compro",
            it_item2_desc: "Perancangan arsitektur ERP berbasis web, integrasi REST API, modul bisnis, serta pembuatan dari awal (end-to-end) & pemeliharaan website company profile kantor berbasis WordPress.",
            it_item3_title: "Mail Domain, Jaringan & Otomatisasi",
            it_item3_desc: "Pengelolaan server email SMTP kantor, webmail, domain & DNS, jaringan enterprise (MikroTik, Cisco, Aruba, Ruijie), aplikasi Python OCR, serta IoT.",
            log_item1_title: "Pengadaan & Administrasi Vendor End-to-End",
            log_item1_desc: "Mengelola seluruh siklus pengadaan via ERP (pembuatan PO, negosiasi harga, evaluasi supplier, dan manajemen pembayaran vendor).",
            log_item2_title: "Kontrol Stok & Verifikasi QC Fisik",
            log_item2_desc: "Verifikasi Surat Jalan (DO), faktur, pelacakan inventaris, serta inspeksi barang masuk/keluar sesuai standar QC klien.",
            adm_item1_title: "Kontrol Dokumen EPC & Proyek QC",
            adm_item1_desc: "Mengelola Test Package, Welding Report, Cleaning Inspection Report, transmittal, dan pengarsipan digital di SharePoint.",
            adm_item2_title: "Validasi Data Excel & Otomatisasi Python",
            adm_item2_desc: "Validasi data proyek menggunakan Excel Tingkat Lanjut (VLOOKUP, HLOOKUP, data matching & reporting) dan otomasi Python OCR (mengurangi sisa dokumen dari 11rb menjadi 2rb).",
            ...
            exp_job1_b2: "Mengembangkan ERP berbasis web (arsitektur aplikasi, integrasi API, modul operasional) serta merancang dari awal & memelihara website company profile (Web Compro) kantor berbasis WordPress.",
            exp_job1_b3: "Mengelola infrastruktur IT, DevOps, dan layanan sistem meliputi Proxmox, Docker, Nginx, database, jaringan, CI/CD pipeline deployment, email SMTP & domain kantor, webmail maintenance, Nextcloud & NAS storage, serta layanan PABX dan CCTV.",
            ...
            exp_job2_b2: "Mengelola kontrol dokumen, transmittal, log sheet, dan dokumentasi proyek menggunakan Microsoft 365 SharePoint.",
            exp_job2_b3: "Melakukan validasi data Excel (VLOOKUP, HLOOKUP, data matching antar sheet, dan reporting) untuk menjamin akurasi dokumentasi.",
            exp_job2_b4: "Mengembangkan aplikasi Python OCR untuk otomatisasi pengolahan dokumen, mengurangi sisa dokumen dari 11.000 menjadi 2.000.",
        ...
        en: {
            ...
            hero_desc: "Bachelor of Informatics Engineering with 4+ years of overall professional experience, including 2+ years specialized in IT Systems & ERP Development, Infrastructure Engineering, and 2 years in Procurement & EPC Project Administration. Combines strong technical engineering skills with deep business process domain knowledge.",
            ...
            about_p1: "Bachelor of Informatics Engineering with 4+ years of overall professional experience, including 2+ years focused on IT Systems, ERP development, and IT Infrastructure, alongside 2 years in Procurement and EPC Project Administration.",
            about_p2: "Combines hands-on software & infrastructure engineering capabilities with real-world operational domain knowledge in procurement, logistics, and document control to build highly accurate digital solutions.",
            ...
            it_item1_title: "Server Infrastructure & Cloud Storage",
            it_item1_desc: "Managing Proxmox, Docker, Nginx, CI/CD pipeline, Nextcloud & NAS cloud storage, Grafana, and Kuma Uptime.",
            it_item2_title: "Web-Based ERP & Web Compro",
            it_item2_desc: "Designing ERP application architecture, REST API integration, module development, and end-to-end development & maintenance of company profile website built from scratch using WordPress.",
            it_item3_title: "Mail Domain, Network & Automation",
            it_item3_desc: "Managing office SMTP email server, webmail, domain & DNS administration, enterprise networks (MikroTik, Cisco, Aruba, Ruijie), Python OCR apps, and IoT.",
            log_item1_title: "End-to-End Procurement & Vendor Admin",
            log_item1_desc: "Managing full procurement cycles via ERP (PO creation, price negotiations, supplier evaluation, and vendor payment management).",
            log_item2_title: "Stock Control & Physical QC Verification",
            log_item2_desc: "Verifying Delivery Orders (DOs), invoices, inventory tracking, and inspecting incoming/outgoing goods as per client QC standards.",
            adm_item1_title: "EPC Document Control & QC Projects",
            adm_item1_desc: "Managing Test Package, Welding Report, Cleaning Inspection Report, transmittal, and digital archiving on M365 SharePoint.",
            adm_item2_title: "Excel Data Validation & Python Automation",
            adm_item2_desc: "Validating project data using Advanced Excel (VLOOKUP, HLOOKUP, data matching & reporting) and Python OCR document processing (reducing outstanding docs from 11k to 2k).",
            ...
            exp_job1_b2: "Develop web-based ERP systems (architecture design, API integration, module development) and build from scratch & maintain company profile website (Web Compro) using WordPress.",
            exp_job1_b3: "Managing IT infrastructure, DevOps, and services: Proxmox, Docker, Nginx, databases, network, CI/CD pipeline, Nextcloud & NAS cloud storage, office domain & SMTP email server management, webmail maintenance, as well as PABX and CCTV services.",
            ...
            exp_job2_b2: "Manage document control, transmittals, log sheets, and project documentation using Microsoft 365 SharePoint.",
            exp_job2_b3: "Perform Excel data validation (VLOOKUP, HLOOKUP, data matching across sheets & reporting) to ensure document accuracy.",
            exp_job2_b4: "Develop Python OCR applications for automated document processing, reducing outstanding docs from 11,000 to 2,000.",
